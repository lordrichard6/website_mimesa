...
const PATH = "/solutions/cafe-bistro";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "meta.solutions.cafeBistro" });
...
export default async function CafeBistroPage() {
  return (
    <main className="min-h-screen bg-white text-brand-coffee">
      <Navbar solid />
      <SolutionsHero solutionKey="cafe-bistro" />
      <CTABanner />
      <Footer />
    </main>
  );
