...
const PATH = "/solutions/hotel-restaurant";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "meta.solutions.hotelRestaurant" });
...
export default async function HotelRestaurantPage() {
  return (
    <main className="min-h-screen bg-white text-brand-coffee">
      <Navbar solid />
      <SolutionsHero solutionKey="hotel-restaurant" />
      <CTABanner />
      <Footer />
    </main>
  );
