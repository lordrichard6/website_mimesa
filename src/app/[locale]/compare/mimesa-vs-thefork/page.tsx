...
const PATH = "/compare/mimesa-vs-thefork";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "meta.compare.thefork" });
...
export default async function MimesaVsTheForkPage() {
  return (
    <main className="min-h-screen bg-white text-brand-coffee">
      <Navbar solid />
      <ComparisonTable competitorKey="thefork" />
      <CTABanner />
      <Footer />
    </main>
  );
