...
const PATH = "/compare/mimesa-vs-resy";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "meta.compare.resy" });
...
export default async function MimesaVsResyPage() {
  return (
    <main className="min-h-screen bg-white text-brand-coffee">
      <Navbar solid />
      <ComparisonTable competitorKey="resy" />
      <CTABanner />
      <Footer />
    </main>
  );
