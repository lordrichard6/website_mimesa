...
function FeatureCard({
  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:border-brand-orange transition-colors reveal">
      ...
      <section className="py-24 px-6 bg-gray-50 reveal">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-12">
          <div className="text-center max-w-3xl">
            <h2 className="text-3xl font-bold text-brand-coffee mb-4">
              {t("speedTitle")}
            </h2>
