...
function FeatureItem({
  ...
  return (
    <li
      className={`flex items-center gap-3 text-sm ${inverted ? "text-white/80" : "text-gray-600"}`}
    >
      <Check
        size={18}
        className={
          inverted ? "text-brand-orange shrink-0" : "text-green-500 shrink-0"
        }
      />
      <span>{text}</span>
    </li>
...
export default function PricingContent() {
  ...
  return (
    <>
      <section className="pt-40 pb-24 px-6 text-center bg-brand-light-grey reveal">
      ...
      <section className="pb-24 px-6 -mt-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Free */}
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-200 flex flex-col reveal">
            <div>
              <h3 className="text-xl font-bold text-brand-coffee">
                {t("free.name")}
              </h3>
              ...
              <div className="my-6">
                <span className="text-4xl font-bold text-brand-coffee">
                  {t("free.price")}
                </span>
          ...
          {/* Starter */}
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-200 flex flex-col reveal stagger-1">
            <div>
              <h3 className="text-xl font-bold text-brand-coffee">
                {t("starter.name")}
              </h3>
          ...
          {/* Pro (Highlighted) */}
          <div className="bg-brand-coffee text-white rounded-2xl p-8 shadow-2xl border border-brand-coffee relative flex flex-col md:-translate-y-4 reveal stagger-2">
          ...
          {/* Enterprise */}
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-200 flex flex-col reveal stagger-3">
            <div>
              <h3 className="text-xl font-bold text-brand-coffee">
                {t("enterprise.name")}
              </h3>
              ...
              <div className="my-6">
                <span className="text-3xl font-bold text-brand-coffee">
                  {t("enterprise.price")}
                </span>
