...
export default function AboutContent() {
  ...
  return (
    <>
      <section className="pt-40 pb-20 px-6 text-center reveal">
        <h1 className="text-4xl md:text-6xl font-bold text-brand-coffee mb-8">
          {t("heroTitle")}{" "}
          <span className="text-brand-orange italic">{t("heroHighlight")}</span>
          {t("heroSuffix")}
        </h1>
      ...
      <section className="py-24 px-6 bg-brand-coffee text-white reveal">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
            {t("valuesTitle")}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="bg-white/10 p-8 rounded-2xl backdrop-blur-sm border border-white/10 reveal">
              <h3 className="text-xl font-bold mb-4 text-brand-orange">
                {t("value1Title")}
              </h3>
              <p className="text-white/80">{t("value1Desc")}</p>
            </div>
            <div className="bg-white/10 p-8 rounded-2xl backdrop-blur-sm border border-white/10 reveal stagger-1">
              <h3 className="text-xl font-bold mb-4 text-brand-orange">
                {t("value2Title")}
              </h3>
              <p className="text-white/80">{t("value2Desc")}</p>
            </div>
            <div className="bg-white/10 p-8 rounded-2xl backdrop-blur-sm border border-white/10 reveal stagger-2">
              <h3 className="text-xl font-bold mb-4 text-brand-orange">
                {t("value3Title")}
              </h3>
